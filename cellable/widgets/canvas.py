...
class Canvas(QtWidgets.QWidget):
    ...
    def mouseReleaseEvent(self, ev):
        if ev.button() == QtCore.Qt.RightButton:
            ...
            if self.createMode == "brush" and self.drawing_mask:
                try:
                    arr = cellable.utils.img_qt_to_arr(self.drawing_mask)
    ...
    def paintEvent(self, event):
        ...
        if (
            ...
            self._ai_model.set_image(
                image=cellable.utils.img_qt_to_arr(self.pixmap.toImage()),
    ...
    def closeEnough(self, p1, p2):
        return cellable.utils.distance(p1 - p2) < (self.epsilon / self.scale)
    ...
    def intersectingEdges(self, point1, point2, points):
        ...
        for i in range(4):
            ...
            if 0 <= ua <= 1 and 0 <= ub <= 1:
                ...
                d = cellable.utils.distance(m - QtCore.QPointF(x2, y2))
                yield d, i, (x, y)
