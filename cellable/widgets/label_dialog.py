...
class LabelDialog(QtWidgets.QDialog):
    def __init__(
        ...
        self.edit.setValidator(cellable.utils.labelValidator())
        ...
        bb.button(bb.Ok).setIcon(cellable.newIcon("done"))
        bb.button(bb.Cancel).setIcon(cellable.utils.newIcon("undo"))
