...
from cellable import PY2
from cellable import __appname__
from cellable import ai
from cellable.ai import MODELS
from cellable.config import get_config
from cellable.label_file import LabelFile
from cellable.label_file import LabelFileError
from cellable.logger import logger
from cellable.shape import Shape
from cellable.widgets import AiPromptWidget
from cellable.widgets import BrightnessContrastDialog
from cellable.widgets import Canvas
from cellable.widgets import FileDialogPreview
from cellable.widgets import LabelDialog
from cellable.widgets import LabelListWidget
from cellable.widgets import LabelListWidgetItem
from cellable.widgets import ToolBar
from cellable.widgets import UniqueLabelQListWidget
from cellable.widgets import ZoomWidget
from cellable.utils import compute_tiff_sam_feature, compute_points_from_mask
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        # see cellable/config/default_config.yaml for valid configuration
        if config is None:
            config = get_config()
        self._config = config
        ...
        self.settings = QtCore.QSettings("cellable", "cellable")
    ...
    def tutorial(self):
        url = "https://github.com/cellableai/cellable/tree/main/examples/tutorial"  # NOQA
        webbrowser.open(url)
